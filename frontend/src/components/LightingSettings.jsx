  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-2">
          ...
          <div className="p-3 rounded-none border border-slate-300 bg-white flex flex-col gap-1.5">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`w-7 h-7 aspect-square flex items-center justify-center rounded-none border text-[10px] font-bold transition-all ${
                  isAnalogEnabled
                    ? 'bg-slate-900 text-white border-slate-900'
      ...
      <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-1.5">
            {['慢', '中', '快'].map((label, idx) => (
              <button
                ...
                className={`w-8 h-8 aspect-square flex items-center justify-center text-xs font-bold rounded-none border transition-all ${
                  speedIndex === idx
                    ? 'bg-slate-900 text-white border-slate-900'
              ...
              {directions.map((d) => {
                ...
                return (
                  <button
                    ...
                    title={d.label}
                    className={`w-7 h-7 aspect-square flex items-center justify-center rounded-none border transition-all ${
                      isCurrent
                        ? 'bg-slate-900 text-white border-slate-900'
                        : 'bg-white border-slate-300 text-slate-700 hover:border-slate-500'
                    }`}
        ...
        {/* 波束粗细 */}
        {(currentEffect === 'wave' || currentEffect === 'current') && (
          <div className="flex flex-col gap-1.5">
            <div className="flex items-center justify-between text-xs font-semibold text-slate-900">
              <span>波束粗细</span>
        ...
        <div className="flex flex-col gap-2 pt-2 border-t border-slate-200">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-900">色彩搭配</span>
            <select
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="w-6 h-6 aspect-square flex items-center justify-center rounded-none bg-white border border-slate-300 text-slate-700 hover:border-slate-500 disabled:opacity-30"
                title="删除色标"
              >
              ...
              <button
                onClick={addStop}
                className="w-6 h-6 aspect-square flex items-center justify-center rounded-none bg-white border border-slate-300 text-slate-700 hover:border-slate-500"
                title="新增色标"
              >
