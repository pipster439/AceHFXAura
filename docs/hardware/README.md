...
| [M605 verified runtime protocol](M605_RUNTIME_PROTOCOL.md) | Alpha.5 Phase 1–3 runtime and Stage 7A explicit 68/68 physical magnetic-key mapping, namespace and apply boundaries |
