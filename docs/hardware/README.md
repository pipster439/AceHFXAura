...
| [M605 verified runtime protocol](M605_RUNTIME_PROTOCOL.md) | Alpha.5 Phase 1–3 Actuation, Static Analog, per-key RT/Deadzone and SpeedTap runtime, mapping and apply boundary |
