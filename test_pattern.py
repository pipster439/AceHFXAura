...
# Test: Static Multi-Color Pattern across keyboard
# 4 distinct color zones:
# 0% (Left/WASD): Green (0, 255, 0)
# 30% (Center): Red (255, 0, 0)
# 65% (Right): Blue (0, 0, 255)
# 90% (Far Right/Arrows): Yellow (255, 255, 0)
payload = {
    "profileID": "3",
    "isPreview": True,
    "data": {
        ...
        "keyboard": {
            ...
            "brightness": "100",
            "analogEffect": "0",
            "speed": "0",          # 0 = Static / frozen (no wave movement!)
...
print(f"[*] Sending Static Multi-Zone Pattern to {url}...")
try:
